...
def main(seed=42, learning_rate=1e-3):
    ...
    save_path = Path(__file__).parent.parent.parent.resolve().joinpath('results', 'mmused-fallacy', 'afc', 'baseline_lstm_wavlm',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Baseline LSTM-WavLM model for fallacy classification")
    parser.add_argument(
        "--seed", 
        type=int, 
        default=42, 
    ...
    print(f"Starting baseline LSTM-WavLM training with:")
