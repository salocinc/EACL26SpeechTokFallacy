...
class BagOfWordsProcessor(ProcessorComponent):
    ...
    def fit(self,
            inputs: List[str],
            context: List[str] = None):
        # Extract text data from the training dataset
    ...
    def __call__(
        ...
        return self.vectorizer.transform(inputs).toarray(), context
    ...
    def reset(
        ...
        self.vectorizer = CountVectorizer(max_features=self.vectorizer.max_features)
        self.vocab = None