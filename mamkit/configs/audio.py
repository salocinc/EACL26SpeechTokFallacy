...
class MFCCsConfig(BaseConfig):
    configs = {
        ConfigKey(dataset='mmused-fallacy',
    ...
    @classmethod
    def mmused_fallacy_afc_anonymous(cls):
        return cls(
            seeds=[42],
            ...
            loss_function=lambda: th.nn.CrossEntropyLoss(
                weight=th.Tensor([
                    0.2586882, 1.05489022, 2.28787879,
                    3.2030303, 4.09689922, 5.18137255
                ])),
            batch_size=4,
            num_classes=6,
        )
